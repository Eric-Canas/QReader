...
SAMPLE_IMG_1 = os.path.join(os.path.dirname(__file__), 'documentation', 'resources', '64x64.png')
SAMPLE_IMG_2 = os.path.join(os.path.dirname(__file__), 'documentation', 'resources', '512x512.jpeg')
SAMPLE_IMG_3 = os.path.join(os.path.dirname(__file__), 'documentation', 'resources', '1024x1024.jpeg')
...
if __name__ == '__main__':
    ...
    for shape, times in results.items():
        print(f"Image shape: {shape} -> Detect: {times['detect']}. Detect and decode: {times['detect_and_decode']}.")